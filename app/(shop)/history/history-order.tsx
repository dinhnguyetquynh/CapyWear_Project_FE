           ...
           <div>
                ...
                <div key={order.orderId} className="border border-gray-300 p-4 rounded-2xl mb-4 pb-2">
                    ...
                    <span className=" text-red-500">
                        {
                            order.status =='PENDING'? 'Đang giao hàng':'Đã giao hàng'
                        }
                    </span>
                    </div>
                    ...
                    <div className="text-right text-lg">Tổng tiền : <span className=" text-red-500">{order.totalOrder.toLocaleString("vi")} VND</span></div>
                </div>
